...
namespace Engine.Renderer
{
    ...
    public struct Color : IEquatable<Color>
    {
        ...
        internal static void SetFormat(SurfaceFormatKHR supportedSurfaceFormats)
        {
        ...
        [CLSCompliant(false)]
        public Color(uint myValue)//AliceBlue (R:240,G:248,B:255,A:255).
        {   //A B G R
            uint Alpha = myValue >> 24;
            uint Blue = myValue >> 16;
            uint Green = myValue >> 8;
            uint Red = myValue;
            //BGRA (255, 248, 240, 255
            //TODO: look at surface format to fix these for other version of colors 
            _packedValue = new Vector4((uint)((uint)Red & 0x000000ffu), (uint)(Green & 0x000000ffu), (uint)(Blue & 0x000000ffu), (uint)(Alpha & 0x000000ffu));
        }
        //0xfffff8f0
        /// <summary>
        ...
        public Color(Color color, int alpha)
        {
            ...
            _packedValue = new Vector4(color._packedValue.ToVector3(), alpha);
        }
        ...
        {
            _packedValue = new Vector4(b, g, r, alpha);
        }
        ...
        public byte R
        {
            get
            {
                unchecked
                {
                    return (byte)this._packedValue.X;
                }
            }
            set
            {
                this._packedValue.X = value;
            }
        }
        /// <summary>
        ...
        public byte G
        {
            get
            {
                unchecked
                {
                    return (byte)(this._packedValue.Y);
                }
            }
            set
            {
                this._packedValue.Y = value;
            }
        }
        ...
        public byte B
        {
            get
            {
                unchecked
                {
                    return (byte)(this._packedValue.Z);
                }
            }
            set
            {
                this._packedValue.Z = value;
            }
        }
        ...
        public byte A
        {
            get
            {
                unchecked
                {
                    return (byte)(this._packedValue.W);
                }
            }
            set
            {
                this._packedValue.W = value;//TOOD: Test
            }
        }
