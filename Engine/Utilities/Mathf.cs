...
namespace Engine.Utilities
{
    ...
    {/// <summary>
     ...
     /// </summary>
        ...
        public static int Pow(float v1, int v2)
        {
            return (int)(Math.Round(Math.Pow(v1, v2)));
        }

        public static int RoundToInt(double p)
        {
            return (int)Math.Round(p);
        }

        public static int RoundToInt(float p)
        {
            return (int)Math.Round(p);
        }

        public static double Log(int level, int baseval)
        {
           return Math.Log(level, baseval);
        }
    }
}