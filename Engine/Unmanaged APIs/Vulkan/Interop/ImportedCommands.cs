...
namespace Vulkan.Interop
{
	public static class NativeMethods
	{
		...
		internal unsafe delegate void DebugUtilsMessengerCallback(DebugUtilsMessageSeverityFlag mySeverity, DebugUtilsMessageTypeFlag myFlags, DebugUtilsMessengerCallbackData* myData, void* UserData);

		internal unsafe delegate void vkCreateDebugUtilsCallbackExt(IntPtr Instance, DebugUtilsMessengerCreateInfoEXT* pCreate, AllocationCallbacks* pAllocator, UInt64* pCallback);
