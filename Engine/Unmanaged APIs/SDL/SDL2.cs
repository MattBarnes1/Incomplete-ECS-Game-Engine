...
namespace SDL2
{
    ...
    public static class SDL
    {
		...
		*/
		...
		[DllImport(nativeLibName, CallingConvention = CallingConvention.Cdecl)]
		public static unsafe extern int SDL_Vulkan_GetInstanceExtensions(
			IntPtr window,
			uint* Extensions,
			out IntPtr myResult
		);
        ...
        /// <param name="flags">0, or one or more <see cref="SDL_WINDOW_FLAGS"/> OR'd together;
        ...
        /// <summary>
        /// Use this function to create a window and Vulcan Rendering
        /// </summary>      
        /// <returns>Returns 0 on success, or -1 on error; call <see cref="SDL_GetError()"/> for more information. </returns>
        [DllImport(nativeLibName, CallingConvention = CallingConvention.Cdecl)]
        public static unsafe extern int SDL_Vulkan_CreateSurface(
            IntPtr CreatedWindow,
            IntPtr WindowInstanceHandler,
            ulong* Surface
        );
		...
		/// </summary>
		/// <param name="window">the window to query (<see cref="SDL_Window"/>)</param>
		/// <returns>Returns a mask of the <see cref="SDL_WINDOW_FLAGS"/> associated with window; see Remarks for details.</returns>
		[DllImport(nativeLibName, CallingConvention = CallingConvention.Cdecl)]
